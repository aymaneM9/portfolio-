...
const ProjectCard = ({
    ...
    return (
        ...
        >
            <div className="bg-tertiary p-5 rounded-2xl w-full flex flex-col h-full
                      hover:shadow-lg hover:shadow-primary/40 transition-all duration-300
                      hover:scale-[1.02]">
                ...
                <div className="relative w-full h-[230px] overflow-hidden rounded-2xl">
                    ...
                    <div className="absolute inset-0 flex justify-end m-3 opacity-0 hover:opacity-100 transition-opacity">
                        <div
                            ...
                            className="bg-black/60 backdrop-blur-md w-10 h-10 rounded-full flex justify-center items-center cursor-pointer hover:bg-black/80 transition-colors"
                        >
                            <img
                                src={"/wev-click.png"}
                                alt="source code"
